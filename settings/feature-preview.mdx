...
1. Go to Settings -> **Feature preview** under "Security"
1. Toggle the switch "on" for the feature you want to enable
1. To disable a feature, toggle the switch "off" and it will be disabled for your team immediately
